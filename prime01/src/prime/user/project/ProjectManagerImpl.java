...
public class ProjectManagerImpl implements ProjectManager {
	...
	@Override
	public List<ProjectBean> getListProjectMemberDetails(String columnSearch, String value, Integer startRow, Integer endRow, Integer projectMemberId) 
			throws SQLException {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("columnSearch", columnSearch);
		map.put("value", value);
	...
	public Integer getCountByColumn(String columnSearch, String value)
		...
		map.put("columnSearch", columnSearch);
		map.put("value", value);
		return (Integer) mapper
				.queryForObject("project.getCountListByCol", map);
	}
	...
	public Map getRoleName(Integer employeeId, Integer projectId)
		...
		hMap = (HashMap) mapper.queryForMap("project.getProjectRoles", map,
				"key", "value");
		return hMap;
	}
	...
	@Override
	public ProjectBean getDataProjectMemberByProjectMemberId(
			Integer projectMemberId) throws SQLException {
		return (ProjectBean) mapper.queryForObject(
				"project.getDataProjectMemberByProjectMemberId",
				projectMemberId);
	}
	...
	public ProjectBean getProjectMemberDetailById(Integer id)
			throws SQLException {
		// TODO Auto-generated method stub
		return (ProjectBean) mapper.queryForObject("project.getDataEmployee",
				id);
	}
