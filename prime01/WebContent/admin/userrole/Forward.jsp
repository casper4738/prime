...
<html:form action="/UserRole">
	...
	<html:hidden name="UserRoleForm" property="message"/>
</html:form>

<logic:equal name="UserRoleForm" property="task" value="<%=Constants.Task.DOADD%>">
	<script>flyToForward('success', '<bean:message key="label.message.insert"/>')</script>
</logic:equal>

<logic:equal name="UserRoleForm" property="task" value="<%=Constants.Task.DOEDIT%>">
