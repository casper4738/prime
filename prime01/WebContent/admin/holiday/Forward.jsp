...
<logic:equal name="HolidayAdminForm" property="task" value="insert">
	<script>flyToForward('success', '<bean:message key="label.message.insert"/>')</script>
</logic:equal>

<logic:equal name="HolidayAdminForm" property="task" value="update">
	<script>flyToForward('success', '<bean:message key="label.message.update"/>')</script>
</logic:equal>

<logic:equal name="HolidayAdminForm" property="task" value="delete">
