...
<head> 
	...
	<script type="text/javascript">
		...
		function submitHandler(id){
			...
			modalSubmitRefreshPageWithoutReturn("task=insertEmployeeToDoList&param2=" + id, '<%=Constants.PAGES_LIST[Constants.Page.MODAL]%>', "", '<%=Constants.PAGES_LIST[Constants.Page.USER_DASHBOARD]%>');
		}
	</script>
	<!-- End JS -->
</head>
			...
			<div class="col-xs-12"><div class="box">
				...
				<div class="search-table">
					...
					<html:select name="ModalForm" property="columnSearch">
						<html:optionsCollection name="listSearchColumnActivity" label="value" value="key"/>
					</html:select>
			            ...
			            <tbody>
			               ...
			               <logic:notEmpty name="listTableData">
								<logic:iterate id="rowData" name="listTableData" indexId="dataIdx">
				                	<tr>
										<logic:iterate id="obj" name="rowData" indexId="rowIdx">
											<logic:equal name="rowIdx" value="5">
					                			<td align="center">
							                		<jsp:include page="/content/Status.jsp">
					                	    			<jsp:param name="status" value="${obj}" />
					                	    		</jsp:include>
	                	    					</td>
											</logic:equal>
				                			<logic:notEqual name="rowIdx" value="5">
				                				<td>${obj}</td>
				                			</logic:notEqual>
				                		</logic:iterate>
					                    <td align="center">
											<input type="button" class="btn bg-olive" style="height:32px" onclick="submitHandler(${rowData[0]})" value='Select'/>
					                    </td>
						             </tr>
					             </logic:iterate>
							</logic:notEmpty>
