...
var L_BadNumber	= "Questo parametro è di tipo \"Numero\" e può contenere solo un segno negativo, cifre (\"0-9\") e il punto come separatore decimale. Correggere il valore del parametro specificato.";
var L_BadCurrency	= "Questo parametro è di tipo \"Valuta\" e può contenere solo un segno negativo, cifre (\"0-9\") e il punto come separatore decimale. Correggere il valore del parametro specificato.";
var L_BadDate	= "Questo parametro è di tipo \"Data\" e deve presentarsi nel formato \"Date(aaaa,mm,gg)\" in cui \"aaaa\" corrisponde all'anno di quattro cifre, \"mm\" corrisponde al mese (ad esempio, gennaio = 1) e \"gg\" corrisponde al numero di giorni del mese specificato.";
