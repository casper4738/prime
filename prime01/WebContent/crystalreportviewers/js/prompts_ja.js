...
var L_BadNumber	= "このパラメータの型は \"数値\" で、負の記号、数字 (\"0-9\")、および小数点のピリオドのみ使用できます。 入力したパラメータの値を修正してください。";
var L_BadCurrency	= "このパラメータの型は \"通貨\" で、負の記号、数字 (\"0-9\")、および小数点のピリオドのみ使用できます。 入力したパラメータの値を修正してください。";
var L_BadDate	= "このパラメータの型は \"日付\" で、その形式 は \"Date(yyyy,mm,dd)\" です。\"yyyy\" は年を表す 4 桁の数字、\"mm\" は月 (例 : 1 月 = 1)、\"dd\" はその月の日を表します。";
