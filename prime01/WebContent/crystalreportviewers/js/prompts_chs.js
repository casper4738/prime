...
var L_BadNumber	= "此参数的类型为 \"Number\" 并且只能包含负号、数字 (\"0-9\") 和句点小数点分隔符。请更正输入的参数值。";
var L_BadCurrency	= "此参数的类型为 \"Currency\" 并且只能包含负号、数字 (\"0-9\") 和句点小数点分隔符。请更正输入的参数值。";
var L_BadDate	= "此参数的类型为 \"Date\"，其格式应为 \"Date(yyyy,mm,dd)\"，其中 \"yyyy\" 是四位数年份，\"mm\" 是月份（例如一月 = 1），\"dd\" 是指定月份的天数。";
var L_BadDateTime 	= "此参数的类型为 \"DateTime\"，正确的格式为 \"DateTime(yyyy,mm,dd,hh,mm,ss)\"。\"yyyy\" 是四位数年份，\"mm\" 是月份（例如一月 = 1），\"dd\" 是月中的某天，\"hh\" 是 24 小时制的小时数，\"mm\" 是分钟数，\"ss\" 是秒数。";
var L_BadTime	= "此参数的类型为 \"Time\"，其格式应为 \"Time(hh,mm,ss)\"，其中 \"hh\" 是 24 小时制的小时数，\"mm\" 是分钟数，\"ss\" 是秒数。";
