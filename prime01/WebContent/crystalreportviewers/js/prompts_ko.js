...
var L_BadNumber	= "이 매개 변수의 형식은 \"Number\"이고 음수 부호, 숫자(\"0-9\") 및 소수 구분 기호(마침표)만 사용할 수 있습니다. 입력한 매개 변수 값을 수정하십시오.";
var L_BadCurrency	= "이 매개 변수의 형식은 \"Currency\"이고 음수 부호, 숫자(\"0-9\") 및 소수 구분 기호(마침표)만 사용할 수 있습니다. 입력한 매개 변수 값을 수정하십시오.";
var L_BadDate	= "이 매개 변수의 형식은 \"Date\"이고 \"Date(yyyy,mm,dd)\" 형식으로 지정해야 합니다. 여기서 \"yyyy\"는 연도(4자리), \"mm\"은 월(예: 1월 = 1), \"dd\"는 지정된 월의 날짜를 나타냅니다.";
var L_BadDateTime 	= "이 매개 변수의 형식은 \"DateTime\"이고 \"DateTime(yyyy,mm,dd,hh,mm,ss)\" 형식으로 지정해야 합니다. 여기서 \"yyyy\"는 연도(4자리), \"mm\"은 월(예: 1월 = 1), \"dd\"는 날짜, \"hh\"는 시간(24시간제), \"mm\"은 분, \"ss\"는 초를 나타냅니다.";
var L_BadTime	= "이 매개 변수의 형식은 \"Time\"이고 \"Time(hh,mm,ss)\" 형식으로 지정해야 합니다. 여기서 \"hh\"는 시간(24시간제), \"mm\"은 분, \"ss\"는 초를 나타냅니다.";
...
function addPromptRangeValue ( inForm, type , paramName)
{
    ...
    if ( lowerBound.type.toLowerCase () != "text" )  //either upper or lower, doesn't matter
    {
