...
<html:form action="/TaskSubordinateUser">
	...
	<html:hidden name="TaskSubordinateUserForm" property="message"/>
...
<logic:equal name="TaskSubordinateUserForm" property="task" value="<%=Constants.Task.ACTIVITY.DOADD%>">
	<script>flyToForward('<%=Constants.Task.GOTOVIEW%>', '<bean:message key="label.message.insert"/>')</script>
</logic:equal>

<logic:equal name="TaskSubordinateUserForm" property="task" value="<%=Constants.Task.ACTIVITY.DOEDIT%>">
	<script>flyToForward('<%=Constants.Task.GOTOVIEW%>', '<bean:message key="label.message.update"/>')</script>
</logic:equal>

<logic:equal name="TaskSubordinateUserForm" property="task" value="<%=Constants.Task.ACTIVITY.DODELETE%>">
	<script>flyToForward('<%=Constants.Task.GOTOVIEW%>', '<bean:message key="label.message.delete"/>')</script>
</logic:equal>

<logic:equal name="TaskSubordinateUserForm" property="task" value="<%=Constants.Task.ACTIVITY.DOCHANGESTATUS%>">
	<script>flyToForward('<%=Constants.Task.GOTOVIEW%>', '<bean:message key="label.message.update"/>')</script>
</logic:equal>
