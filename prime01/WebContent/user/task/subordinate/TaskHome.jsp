...
<body class="skin-blue sidebar-mini">
	<section class="content-header">
		<h1>Manage Tasks<small> As Subordinate</small></h1>
		<ol class="breadcrumb">
		...
		<div class="col-xs-12"><div class="box">
			...
			<div class="search-table">
				<html:form action="/TaskSubordinateUser" >
					...
					<table>
						<tr>
							<td style="padding-left:5px"><html:select name="TaskSubordinateUserForm" property="columnSearch" styleClass="form-control columnSearch">
									<html:optionsCollection name="listSearchColumn" label="value" value="key"/>
								</html:select>
							</td>
							<td style="padding-left:5px"><html:text name="TaskSubordinateUserForm" property="search" styleClass="form-control textSearch" styleId="textSearch"/></td>
							<td style="padding-left:5px">
								<div id="date_start">
								<div class="input-group" style="width:140px"><div class="input-group-addon"><i class="fa fa-calendar" ></i></div>
	     				  					<html:text name="TaskSubordinateUserForm" property="startDate" styleClass="form-control pull-right" styleId="start"/>
	     				  				</div>
	     				  				</div>
	     				  			</td>
							...
							<td style="padding-left:5px">
								<div id="date_until">
								<div class="input-group" style="width:140px"><div class="input-group-addon"><i class="fa fa-calendar" ></i></div>
	     				  					<html:text name="TaskSubordinateUserForm" property="untilDate" styleClass="form-control pull-right" styleId="until" />
	     				  				</div>
	     				  				</div>
   				  			</td>
							<td style="padding-left:5px">
