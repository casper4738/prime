		...
		<div class="col-xs-12"><div class="box">
			...
			<div class="box-body">
                	<html:form action="/ProjectUserAsHead">
                		<html:hidden name="ProjectUserFormAsHead" property="task" value="<%=Constants.Task.DOADD%>"/>
                		...
                		<table class="form-input" align="center" style="width: 500px;">
                			<tr><td width="150px">Project Name</td>
                				<td>:</td>
                				<td><html:text name="ProjectUserFormAsHead" property="projectBean.projectName" styleId="projectName" styleClass="form-control"/></td>
                			</tr>
                			<tr><td></td>
                				<td></td>
                			...
                			<tr><td>Start Date</td>
                				...
                				<td><div class="input-group"><div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                					<html:text name="ProjectUserFormAsHead" property="projectBean.projectStartDate" styleClass="form-control" styleId="startDate"/>
                					</div>
               					</td>
                			</tr>
                			<tr><td></td>
                			...
                			<tr>
                				...
                				<td>:</td>
                				<td><div class="input-group"><div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                						<html:text name="ProjectUserFormAsHead" property="projectBean.projectEstimateDate" styleClass="form-control" styleId="estimateDate"/>
									</div>
								</td>
                			</tr>
                			<tr><td></td>
                			...
                			<tr><td>Project Description</td>
                				<td>:</td>
                				<td><html:textarea name="ProjectUserFormAsHead" property="projectBean.projectDescription" styleId="projectDescription" styleClass="form-control"></html:textarea></td>
                			</tr>
                			<tr><td></td>
                				<td></td>
