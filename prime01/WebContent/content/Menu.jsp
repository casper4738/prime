		...
		<aside class="main-sidebar">
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<logic:iterate id="pageAction" name="listPages" indexId="count" scope="request">
						<li><a href="#" onclick="menuLoadHandler('${pageAction.key}')"><i class="fa fa-dashboard"></i>	<span>${pageAction.value}</span></a></li>
					</logic:iterate>
				</ul>
			</section>
		</aside>
